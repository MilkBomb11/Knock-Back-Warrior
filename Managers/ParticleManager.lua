...
function pm.spawnParticles(color, pAmount, x, y, minXSpeed, maxXSpeed, minYSpeed, maxYSpeed)
  ...
  for i=1,pAmount do
    ...
    table.insert(objects.particles, Particle(x, y, size, size, color, 895, xSpeed, yv))
  end
end
